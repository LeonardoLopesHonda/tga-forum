...
export type PostPublic    = { post_id: number; title: string; content: string; user_id: number };
export type CommentPublic = { comment_id: number; content: string; post_id: number; user_id: number; parent_id: number | null };
